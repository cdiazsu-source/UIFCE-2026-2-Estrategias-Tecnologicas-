...
IDEAS = [
    ...
    dict(
        id="aa-cartelera-fisica",
        cat="Acompañamiento interárea — Próximo ciclo",
        idea="Cartelera física de Apoyos Académicos (AA)",
        hacer="A solicitud de Apoyos Académicos (Ángela Lucía Fierro Aponte, máster de AA), diseñar y producir una cartelera física para difundir los apoyos y servicios del área, con un formato parecido al de la cartelera de Cursos Libres que ya existe. Definir el contenido con AA (qué apoyos, cupos, horarios, cómo acceder), aplicar la línea gráfica vigente, pasar por el flujo de aprobación del grupo Piezas Redes Sociales, imprimir y ubicar la cartelera en los puntos de mayor circulación de la Facultad. El objetivo es aumentar la demanda de los AA.",
        espera="Una cartelera física de AA instalada en la Facultad antes de la mitad del semestre, coherente con la de Cursos Libres, y un aumento medible en las consultas o inscripciones a los apoyos académicos frente al periodo anterior.",
        fundamento="Es una solicitud formal de Apoyos Académicos a ET dentro del acompañamiento interárea. La cartelera física de Cursos Libres ha funcionado como canal de difusión análoga (volantes y carteleras presenciales) y se toma como referencia de formato; replicarla para AA aprovecha un canal ya probado para llegar a estudiantes que no ven las redes.",
        entregables="* Pedir a Cursos Libres el catálogo y la cartelera actual como referencia de formato.\n* Pedir a Apoyos Académicos (Ángela Fierro) el catálogo de apoyos y servicios a difundir, con cupos, horarios y forma de acceso.\n* Propuesta de diseño de la cartelera de AA con la línea gráfica vigente.\n* Aprobación de la pieza por el grupo Piezas Redes Sociales.\n* Cartelera impresa e instalada en los puntos definidos de la Facultad.\n* Seguimiento de la demanda de AA antes y después de instalar la cartelera.",
        priority=False,
    ),
    dict(
