...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  // El perfil junior también puede registrar KPIs de redes y gestionar el checklist.
  const canRecordMetrics = session.authed;
  const canManageChecklist = session.authed;
  ...
  return (
    <html lang="es">
      <body className="min-h-screen bg-background font-sans antialiased">
        <AccessProvider
          canEdit={editable}
          canRecordMetrics={canRecordMetrics}
